...
ALTER TABLE `creature`
	...
	ADD COLUMN `owner` INT(10) UNSIGNED NULL DEFAULT '0' COMMENT 'Creator of the NPC' AFTER `size`,
	ADD COLUMN `editor` INT(10) UNSIGNED NULL DEFAULT '0' COMMENT 'Last account what modified the NPC' AFTER `owner`,
