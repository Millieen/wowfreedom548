...
ALTER TABLE `gameobject`
	...
	ADD COLUMN `editor` INT(10) UNSIGNED NULL DEFAULT '0' COMMENT 'Last account what modified the object' AFTER `creator`,
...
UPDATE IGNORE gameobject SET size = (SELECT size FROM gameobject_template WHERE entry = gameobject.id);