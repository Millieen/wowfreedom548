...
(1021, 'Command: freedom morph add/del')
;
...
-- [CUSTOM COMMANDS]
(@PLAYER, 1000), (@PLAYER, 1001), (@PLAYER, 1002), (@PLAYER, 1003), (@PLAYER, 1004), (@PLAYER, 1005), (@PLAYER, 1006), (@PLAYER, 1007), (@PLAYER, 1008), (@PLAYER, 1009), (@PLAYER, 1010), (@PLAYER, 1011), (@PLAYER, 1012), (@PLAYER, 1013), (@PLAYER, 1014), (@PLAYER, 1015), (@PLAYER, 1016), (@PLAYER, 1017), (@PLAYER, 1018), (@PLAYER, 1019), -- freedom
...
(@MODERATOR, 371), (@MODERATOR, 373), (@MODERATOR, 374), (@MODERATOR, 376), -- gm, gm fly, gm visible
-- go commands (377 - 386) are disabled in favor of custom .goto command
-- gobject commands (387 - 399) are disabled in favor of custom .goto command
-- list commands (436 - 441) are disabled in favor of custom .list command
-- lookup commands (442 - 461) are disabled in ffavor of custom .lookup command
(@MODERATOR, 472), (@MODERATOR, 478), -- group, group summon
(@MODERATOR, 488), (@MODERATOR, 489), -- additem, additemset
...
(@MODERATOR, 498), -- damage
(@MODERATOR, 506), -- guid
(@MODERATOR, 519), -- possess
(@MODERATOR, 520), -- recall
(@MODERATOR, 521), -- repairitems
(@MODERATOR, 522), -- respawn
...
(@MODERATOR, 544), (@MODERATOR, 545), (@MODERATOR, 546), (@MODERATOR, 547), (@MODERATOR, 548), (@MODERATOR, 549), (@MODERATOR, 550), (@MODERATOR, 551), (@MODERATOR, 552), (@MODERATOR, 553), (@MODERATOR, 554), (@MODERATOR, 555), (@MODERATOR, 556), (@MODERATOR, 557), (@MODERATOR, 558), (@MODERATOR, 559), (@MODERATOR, 560), (@MODERATOR, 561), (@MODERATOR, 562), (@MODERATOR, 563), (@MODERATOR, 564), (@MODERATOR, 565), (@MODERATOR, 566), (@MODERATOR, 568), -- modify
