...
public:
    ...
    ChatCommand* GetCommands() const OVERRIDE
    {
        ...
        {
            //{ "additem",          rbac::RBAC_PERM_COMMAND_ADDITEM,          false, &HandleAddItemCommand,          "", NULL }, -- replaced by custom additem command in fcs_misc.cpp
            ...
            //{ "pinfo",            rbac::RBAC_PERM_COMMAND_PINFO,             true, &HandlePInfoCommand,            "", NULL }, -- uses broken/incompatible format strings from trinity_string table causing crashes
    ...
    static bool HandleSummonCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (target)
        {
            ...
            // before GM
            target->TeleportTo(_player->GetMapId(), _player->GetPositionX(), _player->GetPositionY(), _player->GetPositionZ(), target->GetOrientation());
