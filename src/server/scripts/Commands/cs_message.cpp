...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand commandTable[] =
        {
            ...
            { "announce",       rbac::RBAC_PERM_COMMAND_NAMEANNOUNCE,   true, &HandleNameAnnounceCommand, "", NULL },
            { "gmannounce",     rbac::RBAC_PERM_COMMAND_GMNAMEANNOUNCE, true, &HandleGMNameAnnounceCommand, "", NULL },
