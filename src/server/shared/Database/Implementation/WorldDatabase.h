...
enum WorldDatabaseStatements
{
    ...
    */
    ...
    // FREEDOM CMDS
    WORLD_SEL_FREEDOM_TELE_EXACT,
    WORLD_SEL_FREEDOM_TELE,
    WORLD_INS_FREEDOM_TELE,
    WORLD_DEL_FREEDOM_TELE,
    WORLD_SEL_FREEDOM_PRIVATE_TELE,
    WORLD_SEL_FREEDOM_PRIVATE_TELE_EXACT,
    WORLD_INS_FREEDOM_PRIVATE_TELE,
    WORLD_DEL_FREEDOM_PRIVATE_TELE,
    WORLD_SEL_FREEDOM_MORPH,
    WORLD_SEL_FREEDOM_MORPH_EXACT,
    WORLD_INS_FREEDOM_MORPH,
    WORLD_DEL_FREEDOM_MORPH,

    // CUSTOM GO CMDS
    WORLD_SEL_GAMEOBJECT_NEAREST_SINGLE,
    WORLD_SEL_GAMEOBJECT_NEAREST_SINGLE_EID,
    WORLD_SEL_GAMEOBJECT_IS_DISABLED,
    WORLD_UPD_GAMEOBJECT_DISABLED,

    // CUSTOM NPC CMDS
    WORLD_SEL_CREATURE_IS_DISABLED,
    WORLD_UPD_CREATURE_DISABLED,

    // CUSTOM ITEM CMDS
    WORLD_SEL_IS_PUBLIC_ITEM,
    WORLD_UPD_ITEM_VISIBILITY,
