...
enum WorldDatabaseStatements
{
    ...
    */
    ...
    WORLD_SEL_GAMEOBJECT_HISTORY,
    WORLD_SEL_GAMEOBJECT_IS_DISABLED,
    WORLD_UPD_GAMEOBJECT_CREATOR,
    WORLD_UPD_GAMEOBJECT_EDITOR,
    WORLD_UPD_GAMEOBJECT_CREATED,
    WORLD_UPD_GAMEOBJECT_MODIFIED,
    WORLD_UPD_GAMEOBJECT_DISABLED,

    // CUSTOM NPC CMDS
    WORLD_SEL_CREATURE_HISTORY,
    WORLD_SEL_CREATURE_IS_DISABLED,
    WORLD_UPD_CREATURE_CREATOR,
    WORLD_UPD_CREATURE_EDITOR,
    WORLD_UPD_CREATURE_CREATED,
    WORLD_UPD_CREATURE_MODIFIED,
