...
enum WorldDatabaseStatements
{
    ...
    */
    ...
    WORLD_SEL_CREATURE_TEMPLATE_ADDON,
    WORLD_SEL_CREATURE_EQUIP_TEMPLATE,
    ...
    WORLD_SEL_FREEDOM_SPELL,
    WORLD_SEL_FREEDOM_SPELL_SINGLE,
    WORLD_INS_FREEDOM_SPELL,
    WORLD_DEL_FREEDOM_SPELL,
    ...
    // CUSTOM NPC CMDS
    WORLD_SEL_CREATURE_NEAREST_SINGLE,
    WORLD_SEL_CREATURE_NEAREST_SINGLE_EID,
    WORLD_SEL_CREATURE_IS_DISABLED,
    WORLD_UPD_CREATURE_DISABLED,
    WORLD_INS_CREATURE_ADDON_REPLACE,

    // CUSTOM ITEM CMDS
    WORLD_SEL_IS_PUBLIC_ITEM,
    WORLD_SEL_ITEMS_BY_STRING,
    WORLD_UPD_ITEM_VISIBILITY,

    // CUSTOM RAID
    WORLD_SEL_RAID_BY_MEMBER,
    WORLD_SEL_RAID_MEMBERS,
    WORLD_SEL_RAID_SUBGROUP_MEMBERS,
    WORLD_SEL_RAID_IS_ASSISTANT,
    WORLD_SEL_RAID_IS_LEADER,
    WORLD_INS_RAID,
    WORLD_UPD_RAID_ASSIST,
    WORLD_UPD_RAID_SUBGROUP,
    WORLD_DEL_RAID_ALL,
    WORLD_DEL_RAID_MEMBER,
